...
let mockFolders: Folder[] = [
  ...
  {
    id: 'folder-patientHistoryData',
    name: 'Patient History Data',
...
let mockDocuments: Document[] = [
  ...
  {
    id: 'doc-patientHistory-1',
    name: 'Patient Diagnosis History.pdf',
    createdAt: '2023-05-10T10:30:00Z',
    updatedAt: '2023-05-10T10:30:00Z',
    folderId: 'folder-patientHistoryData',
    type: 'document',
    source: 'internal',
    fileType: 'application/pdf',
    size: 1548762,
  ...
  {
    id: 'doc-patientHistory-2',
    name: 'Treatment Records 2023.xlsx',
